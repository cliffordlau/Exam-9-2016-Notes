...
Problem with FF model is that it is derived from empirical evidence, and none of the factors can be identified as hedging a specific source of uncertainty
...
### Optimizatio in a Single Index Market
